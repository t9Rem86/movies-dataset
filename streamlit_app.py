...
if page == "Результаты анализа":
    ...
    fig_roc = px.line(
        ...
        y=tpr,
        labels={
            "x": "Доля ложноположительных (False Positive Rate)",
            "y": "Доля истинно положительных (True Positive Rate)"
        },
    ...
    # FEATURE IMPORTANCE
    # =========================
    st.subheader("🔥 Влияние признаков на предсказание модели")
    ...
    # СРАВНЕНИЕ МОДЕЛЕЙ
    # =========================
    st.subheader("📋 Сравнение результатов модели")
...
- Площадь под ROC-кривой (AUC): **{auc_score:.2f}**
- Наиболее значимые признаки:
  **{importance.index[-1]}**, **{importance.index[-2]}**

ℹ️ Изменение фильтров по возрасту и полу приводит к изменению
качества модели, что указывает на неоднородность факторов риска
сердечно-сосудистых заболеваний у разных групп пациентов.
"""
    )
